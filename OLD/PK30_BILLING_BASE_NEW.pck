CREATE OR REPLACE PACKAGE PK30_BILLING_BASE_NEW
IS
    --
...
END PK30_BILLING_BASE_NEW;
/
CREATE OR REPLACE PACKAGE BODY PK30_BILLING_BASE_NEW
IS
...
BEGIN
    ...
    SELECT BILL_ID, ACCOUNT_ID, BILLING_ID, PROFILE_ID, v_task_id, p_period_id, p_period_id
      FROM (
