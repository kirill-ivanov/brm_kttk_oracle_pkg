CREATE OR REPLACE PACKAGE PK09_INVOICE_BAK
IS
    --
...
END PK09_INVOICE_BAK;
/
CREATE OR REPLACE PACKAGE BODY PK09_INVOICE_BAK
IS
      ...
      FROM (
        ...
        FROM ITEM_T I, ORDER_T O
         WHERE I.BILL_ID = p_bill_id
           ...
           AND (I.SERVICE_ID = p_service_id OR p_service_id IS NULL)
           AND TRUNC(I.DATE_FROM,'mm') = v_date_from
        GROUP BY TAX_INCL
    );
