...
IS
    ...
    -- ---------------------------------------------------------------------------- --
    -- Создать копию указанного л/с
    -- если p_dst_account_no не задан подставляем стандартный
    -- ---------------------------------------------------------------------------- --
...
BEGIN
    ...
    --
    -- формируем номер счета назначения
...
BEGIN
    ...
    -- получаем номер заказа и номер л/с
